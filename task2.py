...
a = int(input('Введите целочисленное значение длины первой стороны треугольника: '))
b = int(input('Введите целочисленное значение длины второй стороны треугольника: '))
c = int(input('Введите целочисленное значение длины третей стороны треугольника: '))
